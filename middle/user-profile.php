...
$sel = "select * from user_tb  where u_id = '$userid'";
	$selr = $con->query($sel);
...
?>
 ...
 <section class="flat-contact" >
                    <div class="container">
                        <div class="row">                      
                            <div class="col-lg-6">
                               ...
                               <img class="img-icon" src="upload/user/<?php echo $selv['u_image']; ?>" style="height: 400px;width: 400px;margin-top:90px;border-radius: 50%;border: 4px solid black;"  alt="images">
                            </div>
                            <div class="col-lg-6">
                                <div class="wrap-contact">
                                    <div class="box-title flex justify-space">
                                        <div class="inner">
                                            <div class="title-ct fs-30 fw-7">Hey, <?php echo $_SESSION['username'] ?> </div> 
                                            <p>Change you details</p>
                                        </div>
                                    ...
                                    <div id="comments" class="comments">
                                        <div class="respond-comment">
                                            ...
                                            <form method="post" class="comment-form form-submit" enctype="multipart/form-data" accept-charset="utf-8"  novalidate="novalidate" >

                                        <fieldset class="">
                                            <label class="fw-6">User name</label>
                                            <input type="text" class="tb-my-input" value="<?php echo $selv['u_name']; ?>" name="u_name" placeholder="User name" >
                                            <img class="img-icon img-name" src="assets/images/icon/login-user.svg" alt="images">
                                        </fieldset>   
                                        <fieldset class="t">
                                            <label class="fw-6">Contact</label>
                                            <input type="number" disabled  class="tb-my-input" value="<?php echo $selv['u_contact']; ?>" name="u_contact" placeholder="Contact" >
                                            <img class="img-icon" src="assets/images/icon/contact-phone.svg" alt="images">
                                        </fieldset> 
										
										<fieldset class="">
                                            <label class="fw-6">Image</label>
											
					                    <input type="hidden" value="<?php echo $selv['u_image']; ?>" name="old_img"/>
					 
                                            <input type="file" class="tb-my-input"  id="formFile" name="u_image" placeholder="" >
                                            <img class="img-icon" src="assets/images/icon/contact-choose.svg" alt="images">
                                        </fieldset>

                                       <fieldset class="">
                                            <label class="fw-6">Address</label>
                                             <textarea  name="u_add" rows="2" tabindex="4" placeholder="Your Address"
                                                aria-required="true"><?php echo $selv['u_add']; ?></textarea> 
                                        </fieldset>
										
										 <fieldset class="">
									   <label class="font-2 fw-8 fs-16">Gender</label>
									   <select class="form-control" name="u_gender">
									   <?php if($selv['u_gender'] == 'Male'){ ?>
									   <option value="Male" selected>Male</option>
									   <option value="Female">Female</option>
									   <option value="Other">Other</option>
									  <?php  } else if($selv['u_gender'] == 'Female'){ ?>
									  ...
									  <?php } ?>
                                        ...
                                        <fieldset class="">
                                            ...
                                            <input type="password" class="input-form password-input" placeholder="Your password" value="<?php echo $selv['u_password']; ?>" name="u_password" id="myInput">
                                        ...
                                        <button class="sc-button"  name="submit" type="sub">
					...
					move_uploaded_file($_FILES['u_image']['tmp_name'],"upload/user/".$_FILES['u_image']['name']);
					...
					//UPDATE QUERY
					$upd = "update user_tb set u_name='$name',u_image='$old_img',u_add='$add',u_gender='$gender',u_password='$password',u_udate='$u_date' where u_id = '$userid'";
