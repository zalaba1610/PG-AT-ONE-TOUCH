 <section class="flat-contact" >
                    <div class="container">
                        <div class="row">                      
                            <div class="col-lg-6">
                               ...
                               <img class="img-icon" src="assets/images/mark/1234.jpg" style="height:600px;width:100%;margin-top:90px"  alt="images">
                            </div>
                            <div class="col-lg-6">
                                <div class="wrap-contact">
                                    <div class="box-title flex justify-space">
                                        <div class="inner">
                                            <div class="title-ct fs-30 fw-7">Owner Sign Up </div> 
                                    ...
                                    <div id="comments" class="comments">
                                        ...
                                        <fieldset class="">
                                            ...
                                            <input type="text" class="tb-my-input" name="o_name" placeholder="User name" pattern="[A-Za-z\s]+" title="Please Enter Valid Name."  required >
                                            <img class="img-icon img-name" src="assets/images/icon/login-user.svg" alt="images">
                                        </fieldset>   
                                        <fieldset class="t">
                                            <label class="fw-6">Contact</label>
                                            <input type="text"  class="tb-my-input" name="o_contact" placeholder="Contact number" maxlength="10" pattern="[0-9]{10}" title="Ex.9876543210"  required  >
                                       ...
                                       <fieldset class="">
                                            <label class="fw-6">Address</label>
                                             <textarea  name="o_add" rows="2" tabindex="4" placeholder="Your Address"
                                                aria-required="true" required></textarea> 
                                        </fieldset>
										
										<fieldset class="">
                                            <label class="fw-6">Image</label>
                                            <input type="file" class="tb-my-input"  id="formFile" name="o_image" placeholder="" required >
                                            <img class="img-icon" src="assets/images/icon/contact-choose.svg" alt="images">
                                        </fieldset>
										
										<fieldset class="">
                                            <label class="fw-6">Id Proof</label>
                                            <input type="file" class="tb-my-input"  id="formFile" name="o_idproof" placeholder="" required>
                                            <img class="img-icon" src="assets/images/icon/contact-choose.svg" alt="images">
                                        </fieldset>
                                        ...
                                        <fieldset class="">
                                            ...
                                            <input type="password" class="input-form password-input" placeholder="Your password"  name="o_password" id="myInput" required>
					...
					//INSERT QUERY
					    $ins = "INSERT INTO `owner_tb`(`o_name`, `o_contact`,`o_add`,`o_image`,`o_idproof`,`o_password`, `o_status`, `o_cdate`, `o_udate`) VALUES  ('$name','$contact','$add','$image','$image1','$password','$status','$c_date','$u_date')";
					
					// CHECK QUERY IN CONNECTION
					if($con->query($ins) == TRUE){
						
						//PAGE REDIRECT
						header("location:index.php?file=signup-owner");
