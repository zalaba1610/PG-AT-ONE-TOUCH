<?php 
session_start();
if(!isset($_SESSION['username']) || !isset($_SESSION['img']) || !isset($_SESSION['time']))
{
...
<!-- End Search Icon-->
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="../upload/other/<?php echo $_SESSION['img'];?>" alt="Profile" class="rounded-circle" style="width:36px; height:36px">
