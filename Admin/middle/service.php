            ...
            <div class="card-body" style="overflow-x:auto;">
              ...
              <table class="table datatable">
				...
				$j = 1;
					 ...
					 $sel = "select * from service_tb,owner_tb,pg_tb where service_tb.pg_id=pg_tb.pg_id and owner_tb.o_id=pg_tb.o_id order by service_tb.sr_id DESC";
					$selr = $con->query($sel);
				...
				<?php } ?></td>
                    ...
                    <td>
				<a href="index.php?file=service&delid=<?php echo $selv['sr_id']; ?>" onclick="return confirm('Are you sure want to Delete.?')" >
