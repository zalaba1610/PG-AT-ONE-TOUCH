            ...
            <div class="card-body" style="overflow-x: auto;">
              ...
              <table class="table datatable">
				...
				$j = 1;
					 ...
					 $sel = "select * from pg_tb, category_tb,area_tb,owner_tb where pg_tb.cat_id=category_tb.cat_id and pg_tb.ar_id = area_tb.ar_id and pg_tb.o_id=owner_tb.o_id order by pg_tb.pg_id DESC";
					$selr = $con->query($sel);
				...
				<td><a href="index.php?file=pg-moredetails&pgid=<?php echo $selv['pg_id']; ?>" >
				<button type="button" class="btn btn-primary"> Details</button>
				</a>
                   
				<a href="index.php?file=pg&delid=<?php echo $selv['pg_id']; ?>" onclick="return confirm('Are you sure want to Delete.?')" >
