          ...
          <div class="card">
			...
			<?php if(isset($_REQUEST['pgreport'])){
				...
				$j = 1;
					...
					$sel = "select * from pg_tb, category_tb,area_tb,owner_tb where pg_tb.cat_id=category_tb.cat_id and pg_tb.ar_id = area_tb.ar_id and pg_tb.o_id=owner_tb.o_id and Date(pg_tb.pg_cdate) between '$s_date' and '$e_date' order by pg_tb.pg_id DESC";
					$selr = $con->query($sel);
