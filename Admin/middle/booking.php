            ...
            <div class="card-body" style="overflow-x:auto;">
              ...
              <table class="table datatable">
				...
				$j = 1;
					 ...
					 $sel = "select * from booking_tb, pg_tb,owner_tb,user_tb where booking_tb.pg_id=pg_tb.pg_id and booking_tb.o_id = owner_tb.o_id and booking_tb.u_id=user_tb.u_id and booking_tb.b_status = '$bookingstatus' order by booking_tb.b_id DESC";
					$selr = $con->query($sel);
